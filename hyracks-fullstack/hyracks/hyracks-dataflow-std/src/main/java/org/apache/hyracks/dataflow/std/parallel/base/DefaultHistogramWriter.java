 ...
 * @author michael
 */
public class DefaultHistogramWriter extends AbstractHistogramWriter {
     ...
     */
    public DefaultHistogramWriter(IHyracksTaskContext ctx, int[] sampleFields, int sampleBasis,
