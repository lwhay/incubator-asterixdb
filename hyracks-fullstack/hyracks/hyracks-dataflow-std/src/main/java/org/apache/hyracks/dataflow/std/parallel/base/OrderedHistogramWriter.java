 ...
 * @author michael
 */
public class OrderedHistogramWriter extends AbstractHistogramWriter {
    private static final Logger LOGGER = Logger.getLogger(OrderedHistogramWriter.class.getName());
     ...
     */
    public OrderedHistogramWriter(IHyracksTaskContext ctx, int[] sampleFields, int sampleBasis,
